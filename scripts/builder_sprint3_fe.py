...
w("frontend/src/api/search.ts", """import { fetchApi } from './client';
...
# 2. frontend/src/api/agents.ts
w("frontend/src/api/agents.ts", """import { fetchApi } from './client';
...
# 3. frontend/src/components/accounts/AgentCockpitCard.tsx
w("frontend/src/components/accounts/AgentCockpitCard.tsx", """import React, { useState } from 'react';
