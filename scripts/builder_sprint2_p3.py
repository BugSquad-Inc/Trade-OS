...
# 1. backend/app/scripts/seed_50_buyers.py
w("backend/app/scripts/seed_50_buyers.py", """import uuid
...
# 2. backend/app/tests/test_data_expansion.py
w("backend/app/tests/test_data_expansion.py", """import pytest
...
print("[SUCCESS] Sprint 2 Part 3 (Seed 50 Buyers & Data Expansion Tests) built successfully")
