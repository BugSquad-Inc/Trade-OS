...
def main():
    ...
    system_prompt = (
        "You are a world-class Principal AI Architect, Enterprise Data Engineering Lead, "
        "and B2B SaaS Chief Product Officer. You are conducting an exhaustive, highly practical, "
        "and brutally honest architectural, product, and commercial audit for an ambitious AI founder "
        "building 'Trade OS' — an AI-powered Market Intelligence Platform for the global leather, "
        "raw materials, and industrial B2B procurement market."
    )

    user_prompt = f"""
# COMPREHENSIVE PROJECT AUDIT & STRATEGIC CONSULTATION REQUEST

## 1. FOUNDER PROFILE & CURRENT SITUATION
I am building a B2B Market Intelligence Platform ('Trade OS') focused initially on the German & European Leather Industry. As a builder entering the advanced AI & data engineering space, I want an honest, deep, and actionable critique of what we have done, what is fundamentally flawed, what advanced AI/Data Engineering practices I should implement, and how to turn this into a commercially viable, profitable SaaS business.
...
## 3. IDENTIFIED PRODUCT & BUSINESS FAILURES (THE POST-MORTEM)
...
### PART A: COMPLETE RE-APPROACH OR ENHANCEMENT?
...
### PART B: SOLVING THE 'SPARSE DATA' CHALLENGE IN INDUSTRIAL NICHES
...
### PART C: ADVANCED AI & AGENTIC IMPLEMENTATION (THE STATE OF THE ART)
...
### PART D: TARGET CUSTOMERS, VALUE PROPOSITION & MONETIZATION
...
### PART E: CONCRETE STEP-BY-STEP ROADMAP FOR A BEGINNER-TO-REVENUE BUILDER
...
"""
    ...
    print("Sending comprehensive audit prompt to Qwen 3.8 Max via TokenRouter...")
    ...
    try:
        with urllib.request.urlopen(req, timeout=180) as resp:
            ...
            with open(output_file, "w", encoding="utf-8") as f:
                f.write(content)
            print("Successfully received and saved Qwen 3.8 Max response!")
            print(f"Total response length: {len(content)} characters.")
    except Exception as e:
        print("Error from Qwen API:", e)
