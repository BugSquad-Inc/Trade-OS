...
# 1. backend/app/scripts/seed_db.py
w("backend/app/scripts/seed_db.py", """import os
import sys
import uuid
...
# 2. backend/app/scripts/run_scoring.py
w("backend/app/scripts/run_scoring.py", """from app.database import SessionLocal
...
print("[SUCCESS] Part 6 (Seed & Scoring Scripts) built successfully")
